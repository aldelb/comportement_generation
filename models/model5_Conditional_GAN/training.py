...
class TrainModel5(Train):

    def __init__(self, gan):
        super(TrainModel5, self).__init__(gan)

    def sample_noise(self, batch_size, dim):
        return np.random.normal(0, 1, (batch_size, dim))

    def test_loss(self, G, D, testloader, criterion_loss):
    ...
    def train_model(self):
        ...
        for epoch in range(self.n_epochs):
            ...
            self.t_loss = self.test_loss(G, D, self.testloader, bce_loss)
